# Occoneechee 421 dashboard help

This guide explains how to read and use the web dashboard. Open `help.html` for the styled, printable version.

## Quick start

1. Confirm the refresh date: **September 12, 2026**. The dashboard is a snapshot, not a live connection.
2. Start on Overview, then use the District control to narrow the view.
3. Use the available detail pages: Training, Districts, Unit Metrics, Coverage.
...
- Workbook: `Dashboard - Occoneechee 421 - 2026-09-12.xlsx`
- Source workbook: https://1drv.ms/x/c/c07448bcf2a847b8/IQDDGRAquZRdQqdhMHd2OvRmAbCtfk53-4db6e1EedX0ER8
